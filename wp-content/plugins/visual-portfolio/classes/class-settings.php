...
class Visual_Portfolio_Settings {
    ...
    public static function admin_enqueue_scripts( $page ) {
        if ( 'portfolio_page_visual-portfolio-settings' === $page ) {
            wp_enqueue_script( 'visual-portfolio-archive-page-selector', visual_portfolio()->plugin_url . 'assets/admin/js/archive-page-selector.min.js', array( 'jquery', 'select2' ), '2.16.0', true );
        }
    }
                    ...
                    'desc'    => '
                        <div class="vpf-pro-note vpf-settings-info-pro">
                            ...
                            <div>
                                ...
                                <a class="vpf-pro-note-button" target="_blank" rel="noopener noreferrer" href="https://visualportfolio.co/pricing/?utm_source=plugin&utm_medium=settings_page&utm_campaign=watermarks&utm_content=2.16.0">' . esc_html__( 'Go Pro', 'visual-portfolio' ) . '</a>
                            </div>
                        </div>
                    ',
                    'type'    => 'html',
                    ...
                    'desc'    => '
                        <div class="vpf-pro-note vpf-settings-info-pro">
                            ...
                            <div>
                                ...
                                <a class="vpf-pro-note-button" target="_blank" rel="noopener noreferrer" href="https://visualportfolio.co/pricing/?utm_source=plugin&utm_medium=settings_page&utm_campaign=social_feeds&utm_content=2.16.0">' . esc_html__( 'Go Pro', 'visual-portfolio' ) . '</a>
                            </div>
                        </div>
                    ',
                    'type'    => 'html',
                    ...
                    'desc'    => '
                        <div class="vpf-pro-note">
                            ...
                            <div>
                                ...
                                <a class="vpf-pro-note-button" target="_blank" rel="noopener noreferrer" href="https://visualportfolio.co/pricing/?utm_source=plugin&utm_medium=settings_page&utm_campaign=white_label&utm_content=2.16.0">' . esc_html__( 'Go Pro', 'visual-portfolio' ) . '</a>
                            </div>
                        </div>
                    ',
                    'type'    => 'html',
